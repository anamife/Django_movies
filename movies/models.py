...
class Movie(models.Model):
	...
	def get_review(self):
		return self.review_set.filter(parent__isnull=True) # Хотим выводить только те отзывы, у которых нет родителя
...
class MovieShots(models.Model):
	...
	movie = models.ForeignKey(Movie, verbose_name='Фильм', on_delete=models.CASCADE) # в классе movie создается столбец с названием movieshots_set
